...
function up(knex) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!(yield knex.schema.hasTable('calendars')))
            return yield knex.schema.createTable('calendars', (table) => {
...
function down(knex) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield knex.schema.dropTable('calendars');
    });
}
exports.down = down;
//# sourceMappingURL=20210310171649_calendars.js.map